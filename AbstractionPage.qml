...
Window{
                        ...
                        Column{
                            ...
                            Rectangle {
                                ...
                                ListView {
                                    ...
                                    id: list_single_actions
                                    visible: false
                                    model: actions_list_model
                                    anchors.fill: parent
                                    flickableDirection: Flickable.VerticalFlick
                                    boundsBehavior: Flickable.StopAtBounds
                                    clip: true
                                    delegate: Item {
                                        ...
                                        MouseArea {
                                            anchors.fill: parent
                                            onClicked: {
                                                list_single_actions.currentIndex = index
                                            }
                                        }
                                    ...
                                    Row{
                                        ...
                                        Button {
                                            ...
                                            onClicked: {
                                                ...
                                                all_events_row.visible = false
                                                list_single_actions.visible = true
                                                one_event_row.visible = true
                                                console.log(list_single_actions.model.rowCount())
                                            }
                                        }
                                        Button {
                                            anchors {
                                            ...
                                            onClicked: {
                                                list_single_actions.visible = false
    ...
    Connections {
        target: candidate_controller
        function onActionschanged(actions_list, len_actions)
        {
